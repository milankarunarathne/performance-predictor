...
x_select_cols_latency_svr = [0, 1, 2, 3, 6]  # additional feature is 6
x_select_cols_latency_xgboost = [0, 1, 2, 3]  # additional feature is nothing
x_select_cols_90th_percentile_svr = [0, 1, 2, 3, 4]  # additional feature is 4
x_select_cols_90th_percentile_xgboost = [0, 1, 2, 3]  # additional feature is nothing
x_select_cols_95th_percentile_svr = [0, 1, 2, 3, 4]  # additional feature is 4
x_select_cols_95th_percentile_xgboost = [0, 1, 2, 3, 6]  # additional feature is 6
x_select_cols_99th_percentile_svr = [0, 1, 2, 3]  # additional feature is nothing
...
parameters_svr_throughput = {} # 'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3], 'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05]
...
parameters_xgboost_throughput = {} # 'max_depth': [3], 'learning_rate': [0.03], 'n_estimators': [80], 'min_child_weight': [2], 'max_delta_step': [0]
...
print xgboost_best_throughput.best_index_
...
parameters_svr_latency = {} # 'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3], 'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]
...
parameters_xgboost_latency = {} # 'max_depth': [5], 'learning_rate': [0.005], 'n_estimators': [1000], 'min_child_weight': [1], 'max_delta_step': [0]
...
parameters_svr_90th_percentile = {} # 'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3], 'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]
...
parameters_xgboost_90th_percentile = {} # 'max_depth': [5], 'learning_rate': [0.009], 'n_estimators': [1000], 'min_child_weight': [1], 'max_delta_step': [0]
...
parameters_svr_95th_percentile = {} # 'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3], 'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]
...
parameters_xgboost_95th_percentile = {} # 'max_depth': [3], 'learning_rate': [0.025], 'n_estimators': [800], 'min_child_weight': [2], 'max_delta_step': [0]
...
parameters_svr_99th_percentile = {} # 'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3], 'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]
...
data_split_99th_percentile_xgboost_test = data_reader(csv_file=summary_data_test, total_row=n_rows,
                                                 ...
                                                 y_column_number=y_select_col_99th_percentile)
#
parameters_xgboost_99th_percentile = {} # 'max_depth': [4], 'learning_rate': [0.03], 'n_estimators': [1000], 'min_child_weight': [2], 'max_delta_step': [0]

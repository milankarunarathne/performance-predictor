...
x_select_cols_throughput_svr = [0, 1, 2, 3]  # additional feature is 4 = Message size * Concurrency users
...
x_train_xg, x_test_xg, y_train_xg, y_test_xg = train_test_split(data_split_throughput_svr[0], data_split_throughput_svr[1], test_size=t_size, random_state=r_seed)

print array_print(y_test_xg)
# #################################################################################

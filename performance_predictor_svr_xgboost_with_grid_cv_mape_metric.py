...
x_select_cols_latency_svr = [0, 1, 2, 3, 8]  # additional feature
x_select_cols_latency_xgboost = [0, 1, 2, 3, 4]
x_select_cols_90th_percentile_svr = [0, 1, 2, 3, 7]
x_select_cols_90th_percentile_xgboost = [0, 1, 2, 3, 4]
x_select_cols_95th_percentile_svr = [0, 1, 2, 3, 10]
...
x_select_cols_load_average_1_minute_svr = [0, 1, 2, 3, 4]
...
# parameters_svr_90th_percentile = {'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3],
#                              'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]}
#
...
parameters_svr_load_average_1_minute = {'kernel': ['rbf', 'poly', 'linear'], 'C': [1E2, 1E3],
                             'epsilon': [0.0001, 0.0005, 0.001, 0.005,  0.01, 0.05, 0.1, 0.5, 1, 5, 10]}
